...
typedef struct _RadarBasicStatus
{
    ...
    unsigned int Timestamp_Seconds;
    unsigned char Timestamp_SyncStatus;
    unsigned char SWVersion_Major;
    unsigned char SWVersion_Minor;
    unsigned char SWVersion_Patch;

    unsigned char Status_VoltageStatus;
    unsigned char Status_TemperatureStatus;
    unsigned char Status_BlockageStatus;
}RadarBasicStatus;
